...
export default function Sidebar({ }: Props) {
  ...
  return (
    <div className={`w-full lg:w-fit  bg-black z-20   bg-opacity-30 fixed top-0 left-0 h-full`}>
      <nav className={`bg-[#1F2A66] flex transition-hidden duration-75 lg:flex max-w-[280px] min-w-[280px] fixed lefy-0  h-full min-h-screen px-4 py-4 flex-col justify-between`}>
        ...
        <div className="flex-col space-y-4">
          ...
          <ul className="flex flex-col space-y-2 mt-24">
            ...
            <li className={`p-2.5 text-gray-400 rounded flex flex-row flex-nowrap space-x-4 items-center text-sm font-medium hover:bg-secondary hover:text-white group cursor-pointer`}>
              ...
              <h6 className=" text-md font-medium">Наличные оплаты</h6>
            </li>
            ...
            <li className={`p-2.5 text-gray-400 rounded flex flex-row flex-nowrap space-x-4 items-center text-sm font-medium hover:bg-secondary hover:text-white group cursor-pointer`}>
              ...
              <h6 className=" text-md font-medium">История</h6>
            </li>
          </ul>
          ...
          <ul className="flex flex-col space-y-2 mt-24">
            ...
            <li className="p-2 py-0 rounded flex flex-row flex-nowrap space-x-2 items-center text-sm font-medium text-slate-500 hover:text-blue-500 group">
              <p className="text-sm font-bold text-white">Отчеты</p>
            </li>
            <li className="w-full border-b border-white/20" />
            ...
            <li className={`p-2.5 text-gray-400 rounded flex flex-row flex-nowrap space-x-4 items-center text-sm font-medium hover:bg-secondary hover:text-white group cursor-pointer`}>
              ...
              <h6 className=" text-md font-medium">Автобусы</h6>
            </li>
            ...
            <li className={`p-2.5 text-gray-400 rounded flex flex-row flex-nowrap space-x-4 items-center text-sm font-medium hover:bg-secondary hover:text-white group cursor-pointer`}>
              ...
              <h6 className=" text-md font-medium">Маршрутки</h6>
            </li>
            ...
            <li className={`p-2.5 text-gray-400 rounded flex flex-row flex-nowrap space-x-4 items-center text-sm font-medium hover:bg-secondary hover:text-white group cursor-pointer`}>
              ...
              <h6 className=" text-md font-medium">Метро</h6>
            </li>
            ...
            <li className={`p-2.5 text-gray-400 rounded flex flex-row flex-nowrap space-x-4 items-center text-sm font-medium hover:bg-secondary hover:text-white group cursor-pointer`}>
              ...
              <h6 className=" text-md font-medium">Общий отчет</h6>
            </li>
            ...
            <li className={`p-2.5 text-gray-400 rounded flex flex-row flex-nowrap space-x-4 items-center text-sm font-medium hover:bg-secondary hover:text-white group cursor-pointer`}>
              ...
              <h6 className=" text-md font-medium">Тарифы</h6>
            </li>
